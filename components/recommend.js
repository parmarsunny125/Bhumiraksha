...
const RecommendationPage = ({ crops }) => {
        ...
        const fetchCropRecommendations = async () => {
            try {
                ...
                crops.forEach(crop => {
                    ...
                    var at_time = metadata[crop.toLowerCase()].time + 2
                    console.log(res.filter(x => x.crop == crop.toLowerCase()))
                    console.log(pred)
            ...
            <div className='p-4'>
                ...
                <div>
                    ...
                    {cropRecommendations_3top.map((crop, index) => (
                        <CropInfo key={index} crop={crop} metadata={metadata} />
                    ))}
                </div>
